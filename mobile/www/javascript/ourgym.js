...
angular.module('ppgym')
    .controller('locationCtrl', function ($scope, $compile, $window, dataFactory) {
        ...
        var initializeMap = function(info) {
            ...
            var contentString = '<div style="color: black;">' + info.Address + '</div>';
        ...
        $scope.calcRouteFromPosition = function(travelMode){
            navigator.geolocation.getCurrentPosition(
                ...
                function(error){
                    alert('Impossibile acquisire la posizione, cerca il percorso ' +
                        'inserendo la localitàà di partenza nel form')
                });
        };
