// Generated on 2015-06-08 using generator-angular-cordova 0.0.1
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        shell: {
            iossimstart: {
                command: 'ios-sim launch platforms/ios/build/ppgym.app --exit' + (device.family !== 'default' ? ' --family ' + device.family : ''),
                options: {
                    stdout: true
                }
            },
